...
log="/home/serizawa/python36_test/prefetch_iterator/chainer/scripts/experiments/result_prefetch_10times_4.log"

CONFIGS=("${config_base}/config_32_1000_4_2_1_1000.json" \
