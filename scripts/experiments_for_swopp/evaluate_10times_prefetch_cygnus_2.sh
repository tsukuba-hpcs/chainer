...
log="${ROOT}/resulsts/evaluate_10times_prefetch_multiprocess_iterator_2"
log_stderr="${ROOT}/logs/evaluate_10times_prefetch_multiprocess_iterator_2/`date "+%Y%m%d_%H%M%S"`"
...
"${config_base}/config_32_4_2_1000.json" \
"${config_base}/config_32_8_2_1000.json" \
"${config_base}/config_32_12_2_1000.json" \
"${config_base}/config_32_16_2_1000.json"\
)
