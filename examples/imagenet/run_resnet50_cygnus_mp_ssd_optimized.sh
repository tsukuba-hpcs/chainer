...
# config='/work/NBB/serihiro/src/chainer/examples/imagenet/resnet50_config_cygnus/multiprocess_iterator/ssd/32_1000_16.json'
echo `date +%Y%m%d_%H%M%S`' start training'
python /work/NBB/serihiro/src/chainer/examples/imagenet/train_imagenet_extended_optimized.py `config2args ${config}`
