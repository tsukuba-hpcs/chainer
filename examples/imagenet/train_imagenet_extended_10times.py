...
def main():
    ...
    if args.dali:
        ...
        if args.iterator == 'prefetch_multiprocess':
          ...
          val = PreprocessedDataset(base_dataset, mean, model.insize,
                                  False)
    ...
    if args.iterator == 'prefetch_multiprocess':
        print(f'count,prefetch_multiprocess_{args.n_prefetch}_{args.prefetchjob}_{args.loaderjob}_elapsed_time', file=sys.stderr)
    else:
        print(f'count,multiprocess_{args.n_prefetch}_{args.loaderjob}_elapsed_time', file=sys.stderr)
    ...
    for _ in range(10):
        ...
        print(f'{i},{elapsed_time}', file=sys.stderr)
        i += 1
