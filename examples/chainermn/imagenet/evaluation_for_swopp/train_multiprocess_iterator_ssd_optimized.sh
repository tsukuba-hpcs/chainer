...
echo `hostname`': This is train_multiprocess_iterator_ssd_optimized.sh'
...
MPSTAT_LOG_FILE="${ROOT}/logs/multiprocess_iterator_ssd/${np}/${CURRENT_DATETIME}_mpstat/`hostname`.log"
MPSTAT_PROC=-1

mkdir -p "${ROOT}/logs/multiprocess_iterator_ssd/${np}/${CURRENT_DATETIME}_mpstat"
