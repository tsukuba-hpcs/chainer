...
LOG_STDERR=${ROOT}/logs/multiprocess_iterator_lustre_10times/${np}/${CURRENT_DATETIME}

mkdir -p ${ROOT}/logs/multiprocess_iterator_lustre_10times/${np}

/usr/sbin/dropcaches 3

/system/apps/cuda/10.1/bin/nvprof \
    -o ${ROOT}/logs/multiprocess_iterator_lustre_10times/${np}/${CURRENT_DATETIME}.%q{OMPI_COMM_WORLD_RANK}.nvvp \
