...
OUT=${ROOT}/results/prefetch_multiprocess_iterator_50_epoch/${np}/${CURRENT_DATETIME}
LOG_DIR=${ROOT}/logs/prefetch_multiprocess_iterator_50_epoch/${np}/${CURRENT_DATETIME}
