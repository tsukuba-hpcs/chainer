...
def main(log, iteration_epoch, process):
    load_minibatch = []
    forward = []
    allreduce = []
    backward = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--iteration_sec", "-i", type=int, default=616)
    ...
    main(base + '/' +  args.log, args.iteration_sec, args.process)
